    ...
    return ( 
        ...
        <div className="w-full flex flex-col flex-wrap gap-4">
            <div>
                ...
                Select the available product type and upload their images.
                </div>
                <div className="text-sm">
                    You must upload an image for each of the types selected otherwise 
                    your types selection will be ignored.
                </div>
            </div>
